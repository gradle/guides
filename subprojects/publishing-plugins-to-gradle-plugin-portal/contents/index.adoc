...
You will need an existing plugin project for this tutorial. If you don't have your own, then you should download the source code for the example Greeting Plugin project https://github.com/gradle/greeting-plugin-example[from GitHub].
