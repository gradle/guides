...
Gradle makes available a simple Java project that you can use to demonstrate build scan capabilities. If you wish to use it, https://github.com/gradle/gradle-build-scan-quickstart[clone or download the repository]. If you prefer to use your own project, you can skip this step.
