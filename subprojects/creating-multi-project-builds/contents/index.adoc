...
----
include::{samples-dir}/groovy-dsl/settings.gradle[tags=after-init]
----
.settings.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/settings.gradle.kts[tags=after-init]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/build.gradle[tags=jcenter]
----
.build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/build.gradle.kts[tags=jcenter]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/build.gradle[tags=subproject-versions]
----
.build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/build.gradle.kts[tags=subproject-versions]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/greeting-library/build.gradle[]
----
.greeting-library/build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/greeting-library/build.gradle.kts[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/settings.gradle[tags=greeting-library]
----
.settings.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/settings.gradle.kts[tags=greeting-library]
----
...
[source,groovy]
----
include::{samples-dir}/groovy-dsl/greeting-library/src/main/groovy/greeter/GreetingFormatter.groovy[]
----
...
[source,groovy]
----
include::{samples-dir}/groovy-dsl/greeting-library/src/test/groovy/greeter/GreetingFormatterSpec.groovy[]
----
...
include::{samples-dir}/groovy-dsl-clean-output-build-greeting-library/out.txt[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/greeter/build.gradle[tags=basic-script]
----
.greeter/build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/greeter/build.gradle.kts[tags=basic-script]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/settings.gradle[tags=application]
----
.settings.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/settings.gradle.kts[tags=application]
----
...
[source,java]
----
include::{samples-dir}/groovy-dsl/greeter/src/main/java/greeter/Greeter.java[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/greeter/build.gradle[tags=main-class-name]
----
.greeter/build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/greeter/build.gradle.kts[tags=main-class-name]
----
...
...
include::{samples-dir}/groovy-dsl-clean-error-message-1/err.txt[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/greeter/build.gradle[tags=project-dependency]
----
.greeter/build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/greeter/build.gradle.kts[tags=project-dependency]
----
...
include::{samples-dir}/groovy-dsl-clean-output-greeter-app/out.txt[]
----
...
include::{samples-dir}/groovy-dsl/spock.gradle[]
----
.greeter/build.gradle.kts
[source.multi-language-sample,kotlin]
----
...
include::{samples-dir}/kotlin-dsl/spock-declarative.gradle.kts[]
----
...
[source,java]
----
include::{samples-dir}/groovy-dsl/greeter/src/test/groovy/greeter/GreeterSpec.groovy[]
----
...
include::{samples-dir}/groovy-dsl-clean-output-test-app/out.txt[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/build.gradle[tags=plugins]
----
.build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/build.gradle.kts[tags=plugins]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/docs/build.gradle[]
----
.docs/build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/docs/build.gradle.kts[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/settings.gradle[tags=documentation]
----
.settings.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/settings.gradle.kts[tags=documentation]
----
...
[literal,subs=none]
....
include::{samples-dir}/groovy-dsl/docs/src/docs/asciidoc/greeter.adoc[]
....
...
include::{samples-dir}/groovy-dsl-clean-output-run-asciidoctor/out.txt[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/greeter/build.gradle[tags=link-docs]
----
.greeter/build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/greeter/build.gradle.kts[tags=link-docs]
----
...
include::{samples-dir}/groovy-dsl-clean-output-build-with-docs/out.txt[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/build.gradle[tags=common-code-1]

include::{samples-dir}/groovy-dsl/spock.gradle[indent=4]
include::{samples-dir}/groovy-dsl/build.gradle[tags=common-code-2]
----
.build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/build.gradle.kts[tags=common-code-1]

include::{samples-dir}/kotlin-dsl/spock.gradle.kts[indent=4]
include::{samples-dir}/kotlin-dsl/build.gradle.kts[tags=common-code-2]
----
