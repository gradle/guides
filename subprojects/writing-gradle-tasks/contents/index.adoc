...
----
include::{samples-dir}/groovy-dsl/code/part1/custom-hello.gradle[]
----

.build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/code/part1/custom-hello.gradle.kts[]
----
<1> Register a new ad-hoc task called `hello`.
...
include::{samples-dir}/groovy-dsl/output/part1/gradle-tasks.txt[]
----
...
[listing.terminal]
----
include::{samples-dir}/groovy-dsl/output/part1/gradle-tasks-setup.txt[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/code/part2/custom-hello.gradle[]
----

.build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/code/part2/custom-hello.gradle.kts[]
----
...
include::{samples-dir}/groovy-dsl/output/part2/gradle-tasks.txt[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/code/part3/custom-hello.gradle[]
----

.build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/code/part3/custom-hello.gradle.kts[]
----
...
<2> Although other task classes from the Gradle API can be used in specific circumstances, extending `{language-reference}org.gradle.api.DefaultTask.html[DefaultTask]` is the most common scenario.
...
include::{samples-dir}/groovy-dsl/output/part3/gradle-hello.txt[]
----
...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/groovy-dsl/code/part3/german-hello.gradle[tags=german]
----

.build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/kotlin-dsl/code/part3/german-hello.gradle.kts[tags=german]
----
...
include::{samples-dir}/groovy-dsl/output/part3/gradle-tasks.txt[]
----
...
include::{samples-dir}/groovy-dsl/output/part3/gradle-gutentag.txt[]
----
...
* Register an ad-hoc task and add an action using `doLast`.
* Document a task.
* Convert an ad-hoc task to a custom Gradle task type and register task instances.
* Use `@TaskAction` to set a default action for a task type.

== Next steps

* Having classes in a build script will soon lead to a messy and potentially unmaintainable build script. Learn how to link:{user-manual}organizing_build_logic.html[organize your build logic].
* Read more about link:{user-manual}tutorial_using_tasks.html[using tasks], and {language-reference}org.gradle.api.Task.html[predefined tasks and task types].
