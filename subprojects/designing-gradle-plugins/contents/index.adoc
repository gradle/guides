...
The recommendation to use a statically-typed language is independent from the language choice for writing tests for your plugin code. The use of dynamic Groovy and (its very capable testing and mocking framework) link:https://spockframework.org/spock/docs/1.1-rc-3/index.html[Spock] is a very viable and common option.
