...
In this guide, we'll discuss how to configure link:https://www.jenkins.io/[Jenkins] for a typical Gradle project.
...
On the https://www.jenkins.io/download/[Jenkins website] you can pick from a variety of distributions.
...
* https://www.jenkins.io/doc/book/using/using-credentials/[Using credentials with Jenkins]
* https://www.jenkins.io/solutions/pipeline/[Pipeline as code with Jenkins]
