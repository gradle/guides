...
NOTE: Shell commands are shown for Unix-based systems. Windows has analogous commands for each.
...
Samples for different use cases can be found in the link:https://docs.gradle.org/current/samples/index.html[Gradle user manual].
