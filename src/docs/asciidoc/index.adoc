...
Build scans are a feature provided by Gradle Inc. that aggregate information across multiple build runs and make those dianotistics available to you online as a report. These have several benefits over a single build profile report:
