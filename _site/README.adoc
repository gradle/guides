= Building Java 9 Modules image:https://travis-ci.org/gradle-guides/building-java-9-modules.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/building-java-9-modules?branch=master"]
