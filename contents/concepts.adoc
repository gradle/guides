...
Artifacts in the build cache are uniquely identified by a _https://docs.gradle.org/nightly/userguide/build_cache.html#sec:task_output_caching_details[build cache key].
