...
Gradle supports a variety of link:{user-manual}dependency_management.html#sub:module_dependencies[notations]. The one used above is probably the most popular, which uses what is most commonly known as Maven coordinates.
...
For example the JFiglet library is released under http://www.gnu.org/licenses/gpl-2.0.html[GPL 2.0]. This means that should you want to release the application you have just built, it will also need to be under GPL 2.0.
