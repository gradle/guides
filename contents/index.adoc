...
====
include::sample[dir="code/declarative-scripts/declarative-android",files="settings.gradle.kts[tags=repo]"]
====
...
====
include::sample[dir="code/declarative-scripts/declarative-android",files="settings.gradle.kts[tags=plugin]"]
====
...
====
include::sample[dir="code/declarative-scripts/declarative-android",files="build.gradle.kts[]"]
====
...
The Gradle Kotlin DSL embraces the new API by making the DSL sugar use it by default. Rest assured, the whole Gradle API remains available.
...
====
include::sample[dir="code/configuring-tasks",files="basics.gradle[tags=single-lazy]"]
include::sample[dir="code/configuring-tasks",files="basics.gradle.kts[tags=single-lazy]"]
====

.Using the eager API & DSL
====
include::sample[dir="code/configuring-tasks",files="basics.gradle[tags=single-eager]"]
include::sample[dir="code/configuring-tasks",files="basics.gradle.kts[tags=single-eager]"]
====
...
.Using the configuration avoidance API & DSL
====
include::sample[dir="code/configuring-tasks",files="basics.gradle[tags=untyped-lazy]"]
include::sample[dir="code/configuring-tasks",files="basics.gradle.kts[tags=untyped-lazy]"]
====

.Using the eager API & DSL
====
include::sample[dir="code/configuring-tasks",files="basics.gradle[tags=untyped-eager]"]
include::sample[dir="code/configuring-tasks",files="basics.gradle.kts[tags=untyped-eager]"]
====
...
.Using the configuration avoidance API & DSL
====
include::sample[dir="code/configuring-tasks",files="basics.gradle[tags=config-lazy]"]
include::sample[dir="code/configuring-tasks",files="basics.gradle.kts[tags=config-lazy]"]
====

.Using the eager API & DSL
====
include::sample[dir="code/configuring-tasks",files="basics.gradle[tags=config-eager]"]
include::sample[dir="code/configuring-tasks",files="basics.gradle.kts[tags=config-eager]"]
====
...
.Using the configuration avoidance API & DSL
====
include::sample[dir="code/configuring-tasks",files="basics.gradle[tags=reference-lazy]"]
include::sample[dir="code/configuring-tasks",files="basics.gradle.kts[tags=reference-lazy]"]
====

.Using the eager API & DSL
====
include::sample[dir="code/configuring-tasks",files="basics.gradle[tags=reference-eager]"]
include::sample[dir="code/configuring-tasks",files="basics.gradle.kts[tags=reference-eager]"]
====
...
.Using the configuration avoidance API & DSL
====
include::sample[dir="code/configuring-tasks",files="spring-boot.gradle[tags=lazy]"]
include::sample[dir="code/configuring-tasks",files="spring-boot.gradle.kts[tags=lazy]"]
====

.Using the eager API & DSL
====
include::sample[dir="code/configuring-tasks",files="spring-boot.gradle[tags=eager]"]
include::sample[dir="code/configuring-tasks",files="spring-boot.gradle.kts[tags=eager]"]
====
...
====
include::sample[dir="code/creating-tasks",files="project.gradle[]"]
include::sample[dir="code/creating-tasks",files="project.gradle.kts[]"]
====
...
.Using the configuration avoidance API & DSL
====
include::sample[dir="code/creating-tasks",files="task-container-lazy.gradle[tags=container-api]"]
include::sample[dir="code/creating-tasks",files="task-container-lazy.gradle.kts[tags=container-api]"]
====

.Using the eager API & DSL
====
include::sample[dir="code/creating-tasks",files="task-container-eager.gradle[tags=container-api]"]
include::sample[dir="code/creating-tasks",files="task-container-eager.gradle.kts[tags=container-api]"]
====
...
.Using the configuration avoidance API & DSL
====
include::sample[dir="code/creating-tasks",files="reference-lazy.gradle[tags=reference]"]
include::sample[dir="code/creating-tasks",files="reference-lazy.gradle.kts[tags=reference]"]
====

.Using the eager API & DSL
====
include::sample[dir="code/creating-tasks",files="reference-eager.gradle[tags=reference]"]
include::sample[dir="code/creating-tasks",files="reference-eager.gradle.kts[tags=reference]"]
====
...
.Using the configuration avoidance API & DSL
====
include::sample[dir="code/creating-tasks",files="task-container-lazy.gradle[tags=typed-container-api]"]
include::sample[dir="code/creating-tasks",files="task-container-lazy.gradle.kts[tags=typed-container-api]"]
====

.Using the eager API & DSL
====
include::sample[dir="code/creating-tasks",files="task-container-eager.gradle[tags=typed-container-api]"]
include::sample[dir="code/creating-tasks",files="task-container-eager.gradle.kts[tags=typed-container-api]"]
====
...
.Using the configuration avoidance API & DSL
====
include::sample[dir="code/creating-tasks",files="reference-lazy.gradle[tags=typed-reference]"]
include::sample[dir="code/creating-tasks",files="reference-lazy.gradle.kts[tags=typed-reference]"]
====

.Using the eager API & DSL
====
include::sample[dir="code/creating-tasks",files="reference-eager.gradle[tags=typed-reference]"]
include::sample[dir="code/creating-tasks",files="reference-eager.gradle.kts[tags=typed-reference]"]
====
...
====
include::sample[dir="code/configurations-and-dependencies",files="declarative.gradle[]"]
include::sample[dir="code/configurations-and-dependencies",files="declarative.gradle.kts[]"]
====
...
====
include::sample[dir="code/configurations-and-dependencies",files="imperative.gradle[]"]
include::sample[dir="code/configurations-and-dependencies",files="imperative-string-reference.gradle.kts[]"]
====
...
====
include::sample[dir="code/configurations-and-dependencies",files="imperative.gradle[]"]
include::sample[dir="code/configurations-and-dependencies",files="imperative-delegated-properties.gradle.kts[]"]
====
...
====
include::sample[dir="code/configurations-and-dependencies",files="custom.gradle[tags=custom]"]
include::sample[dir="code/configurations-and-dependencies",files="custom.gradle.kts[tags=delegated-properties]"]
====
...
====
include::sample[dir="code/configurations-and-dependencies",files="custom.gradle.kts[tags=string-reference]"]
====
...
====
include::sample[dir="code/interoperability",files="closureOf.gradle.kts[tags=closureOf]"]
====
...
====
include::sample[dir="code/interoperability",files="delegateClosureOf.gradle.kts[tags=delegateClosureOf]"]
====
...
====
include::sample[dir="code/interoperability",files="withGroovyBuilder.gradle.kts[tags=withGroovyBuilder]"]
====
