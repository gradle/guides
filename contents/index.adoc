...
From inside the new project directory, run the `init` task and select the `swift-library` project type when prompted. For the other questions, press enter to use the default values.
