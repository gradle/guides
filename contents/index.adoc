...
Some builds with slow configuration time (please check out the link:https://guides.gradle.org/performance/#configuration[performance guide]) the IDE may feel unresponsive when editing scripts.
