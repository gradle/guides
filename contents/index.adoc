...
[listing]
----
$ gradle init --type groovy-library --package guidesamples
...
[source,groovy]
----
include::{gradle-outdir}/files/src/main/groovy/guidesamples/Library.groovy[tags=source-code]
----
...
[source,groovy]
----
include::{gradle-outdir}/files/src/test/groovy/guidesamples/LibraryTest.groovy[]
----

The generated test class has a single https://spockframework.org[Spock specification]. The test instantiates the `Library` class, invokes the `someLibraryMethod` method, and checks that the returned value is `true`.
...
[source,groovy]
----
include::{gradle-outdir}/files/src/main/groovy/guidesamples/Library.groovy[tags=groovy-doc]
----
