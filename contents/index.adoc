...
[source.multi-language-sample,groovy]
----
include::{samples-dir}/build.gradle[tags=plugin_bundle_global_information]
----
.build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/build.gradle.kts[tags=plugin_bundle_global_information]
----
...
include::{samples-dir}/build.gradle[tags=plugin_bundle_plugin_definitions]
----
.build.gradle.kts
[source.multi-language-sample,kotlin]
----
include::{samples-dir}/build.gradle.kts[tags=gradle-plugin]
include::{samples-dir}/build.gradle.kts[tags=plugin_bundle_plugin_definitions]
----
