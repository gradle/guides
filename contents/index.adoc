...
include::../samples/auto-applied-build-scan-plugin.sample.out[]
----
...
====
include::sample[dir="samples/groovy-dsl/build-scan-from-build-script",files="build.gradle[tags=build-scan-plugin-plugins-apply]"]
include::sample[dir="samples/kotlin-dsl/build-scan-from-build-script",files="build.gradle.kts[tags=build-scan-plugin-plugins-apply]"]
====
...
====
include::sample[dir="samples/groovy-dsl/build-scan-from-build-script",files="build.gradle[tags=build-scan-dsl]"]
include::sample[dir="samples/kotlin-dsl/build-scan-from-build-script",files="build.gradle.kts[tags=build-scan-dsl]"]
====
...
include::../samples/build-scan-from-build-script.sample.out[]
----
...
====
include::sample[dir="samples/groovy-dsl/build-scan-from-init-script",files="buildScan.gradle[]"]
include::sample[dir="samples/kotlin-dsl/build-scan-from-init-script",files="buildScan.init.gradle.kts[]"]
====
