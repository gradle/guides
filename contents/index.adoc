...
----
include::{codedir}/java/org/example/mylib/Greeter.java[tags=code]
----
...
.build.gradle
----
include::{projdir}/gradle/java.gradle[tags=plugin]
----
...
.build.gradle
----
include::{projdir}/gradle/java.gradle[tags=version]
----
...
.build.gradle
----
include::{projdir}/gradle/java.gradle[tags=jar]
----
...
The `java` plugin has built-in support for Java's API documentation tool via the `javadoc` task.

Annotate the `Greeter.java` file with Javadoc markup.

[source,java]
.src/main/java/org/example/mylib/Greeter.java
----
include::{codedir}/java/org/example/mylib/Greeter.java[tags=javadoc]
----
