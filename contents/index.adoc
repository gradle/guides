...
====
include::sample[dir="groovy-dsl/build-scan-from-build-script",files="build.gradle[tags=build-scan-plugin-plugins-apply]"]
include::sample[dir="kotlin-dsl/build-scan-from-build-script",files="build.gradle.kts[tags=build-scan-plugin-plugins-apply]"]
====
...
====
include::sample[dir="groovy-dsl/build-scan-from-build-script",files="build.gradle[tags=build-scan-dsl]"]
include::sample[dir="kotlin-dsl/build-scan-from-build-script",files="build.gradle.kts[tags=build-scan-dsl]"]
====
...
====
include::sample[dir="groovy-dsl/build-scan-from-init-script",files="buildScan.gradle[]"]
include::sample[dir="kotlin-dsl/build-scan-from-init-script",files="buildScan.init.gradle.kts[]"]
====
