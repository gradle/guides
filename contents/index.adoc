...
NOTE: This guide uses examples written in Groovy in order to keep the code simple and readable.  Most custom logic
written for production use would likely be written in Java, which exhibits better performance and is the recommended
language for custom tasks and plugins.
...
Now, create a custom task class in your `buildSrc/src/main/groovy` directory.  You should name this class `CreateMD5`.

.buildSrc/src/main/groovy/CreateMD5.groovy
[source,groovy]
----
include::{samplescodedir}/custom-task/buildSrc/src/main/groovy/CreateMD5.groovy[]
----
...
<4> Insert an artificial sleep to simulate hashing a large file.
...
[source,groovy]
----
include::{samplescodedir}/no-isolation/buildSrc/src/main/groovy/GenerateMD5.groovy[]
----
...
[source,groovy]
----
include::{samplescodedir}/no-isolation/buildSrc/src/main/groovy/CreateMD5.groovy[]
----
...
[source, groovy]
----
include::{samplescodedir}/classloader-isolation/buildSrc/src/main/groovy/CreateMD5.groovy[]
----
...
[source,groovy]
----
include::{samplescodedir}/process-isolation/buildSrc/src/main/groovy/CreateMD5.groovy[]
----
