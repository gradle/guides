...
include::{samplesoutputdir}/auto-applied-build-scan-plugin/autoAppliedBuildScanPlugin.out[]
----
...
====
include::sample[dir="{samplescodedir}/build-scan-from-build-script",files="build.gradle[tags=build-scan-plugin-plugins-apply]"]
include::sample[dir="{samplescodedir}/build-scan-from-build-script",files="build.gradle.kts[tags=build-scan-plugin-plugins-apply]"]
====
...
====
include::sample[dir="{samplescodedir}/build-scan-from-build-script",files="build.gradle[tags=build-scan-dsl]"]
include::sample[dir="{samplescodedir}/build-scan-from-build-script",files="build.gradle.kts[tags=build-scan-dsl]"]
====
...
include::{samplesoutputdir}/build-scan-from-build-script/buildScan.out[]
----
...
====
include::sample[dir="{samplescodedir}/build-scan-from-init-script",files="buildScan.gradle[]"]
include::sample[dir="{samplescodedir}/build-scan-from-init-script",files="buildScan.gradle.kts[]"]
====
