...
----
<1> Declare package-lock.json and app to be relocatable. https://guides.gradle.org/build-cache-practices/#relocatability[Learn why this is important for caching].
