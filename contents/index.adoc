...
=== Clone https://github.com/gradle-guides/gradle-site-plugin[Gradle Site Plugin] repository
...
include::contribute[repo-path="gradle-guides/executing-gradle-builds-on-jenkins"]
