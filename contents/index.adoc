...
It is considered good practice to create documentation for a software project. Although there is a number of authoring methods to accomplish this goal, you will be using the very popular http://asciidoctor.org/[Asciidoctor] tool.
