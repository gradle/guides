...
[source,groovy]
----
include::{samplesdir}/code/part1/custom-hello.gradle[]
----
...
include::{samplesdir}/output/part1/gradle-tasks.txt[]
----
...
[listing.terminal]
----
include::{samplesdir}/output/part1/gradle-tasks-setup.txt[]
----
...
[source,groovy]
----
include::{samplesdir}/code/part2/custom-hello.gradle[]
----
...
include::{samplesdir}/output/part2/gradle-tasks.txt[]
----
...
[source,groovy]
----
include::{samplesdir}/code/part3/custom-hello.gradle[]
----
...
include::{samplesdir}/output/part3/gradle-hello.txt[]
----
...
[source,groovy]
----
include::{samplesdir}/code/part3/german-hello.gradle[tags=german]
----
...
include::{samplesdir}/output/part3/gradle-tasks.txt[]
----
...
include::{samplesdir}/output/part3/gradle-gutentag.txt[]
----
