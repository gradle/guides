...
Follow the [Gradle Build Scan plugin docs](https://docs.gradle.com/enterprise/gradle-plugin/#applying_the_plugin) to apply the build scan plugin to your project.
...
You can avoid having to add the plugin and license agreement to every build by [using a Gradle init script](https://docs.gradle.com/enterprise/gradle-plugin/#many-projects). 
