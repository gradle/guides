...
[source,java]
----
include::{gradle-outdir}/groovy-dsl-files/src/main/java/demo/Library.java[tags=source-code]
----
...
[source,java]
----
include::{gradle-outdir}/groovy-dsl-files/src/test/java/demo/LibraryTest.java[]
----
...
[source,java]
----
include::{gradle-outdir}/groovy-dsl-files/src/main/java/demo/Library.java[tags=java-doc]
----
