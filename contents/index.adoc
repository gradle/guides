...
If you are using the profiler, you can get similar (but less detailed) information can by running this command:
...
There is also a _"Task execution"_&nbsp; tab which shows details including cacheablity of the tasks that were executed. Clicking on any of the categories will take you to the Timeline screen with just tasks of that category highlighted.
