...
If you happen to be a beginner to Gradle please start by working through the link:https://gradle.org/guides#getting-started[Getting Started Guides on Gradle development] first while referencing the link:https://docs.gradle.org/current/userguide/userguide.html[Gradle User Manual] to go deeper.
...
[source,groovy]
----
include::{convention-over-configuration}/build.gradle[]
----
...
[source,java]
----
include::{capabilities-vs-conventions}/buildSrc/src/main/java/MyBasePlugin.java[]
----

.MyPlugin.java
[source,java]
----
include::{capabilities-vs-conventions}/buildSrc/src/main/java/MyPlugin.java[]
----
...
[source,groovy]
----
include::{gradle-api}/build.gradle[tags=dependencies]
----
...
[source,groovy]
----
include::{external-libraries}/build.gradle[]
----
