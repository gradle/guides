...
If your build is a multi-project build, like mostly all *Android* builds for example, please also read the subsequent section aboutt link:{user-manual}kotlin_dsl.html#sec:multi_project_builds[multi-project builds].
