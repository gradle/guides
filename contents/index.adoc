...
We have a complete guide about https://guides.gradle.org/using-build-cache/[configuring and using the build cache]. It covers the different scenarios caching can improve, and detailed discussions of the different caveats you need to be aware of when enabling caching for a build.
