...
This mechanism makes it very easy to generate ad-hoc, one-off build scans without having to configure the plugin in your build. If you need finer grained configuration, you can configure the build-scan plugin in a build or init script as described in the following sections.
