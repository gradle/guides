...
The file `src/main/java/jvm/library/Library.java` is shown here:

.Generated src/main/java/Library.java
[source,java]
----
include::{gradle-outdir}/groovy-dsl-files/src/main/java/jvm/library/Library.java[tags=source-code]
----
...
[source,java]
----
include::{gradle-outdir}/groovy-dsl-files/src/test/java/jvm/library/LibraryTest.java[]
----
...
[source,java]
----
include::{gradle-outdir}/groovy-dsl-files/src/main/java/jvm/library/Library.java[tags=java-doc]
----
