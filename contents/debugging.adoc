...
To quickly compare two builds, open the build scans of interest, select the _"adjacent scan"_ icon at the top of the page, and click _"compare"_ next to the build you want to compare it to.
