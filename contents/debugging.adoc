...
3. Select a previous or preceding build for the same project as a scan by clicking the image:previous-next-scan.svg[workspace,role="inline-icon", width="22"] icon and then clicking the image:compare-small-b.svg[compare b,role="inline-icon",width="30"] icon next to the build you want to compare.
