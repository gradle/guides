= Using the Worker API image:https://travis-ci.org/gradle-guides/using-the-worker-api.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/using-the-worker-api?branch=master"]
