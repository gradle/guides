...
- Functional testing with link:https://docs.gradle.org/current/userguide/test_kit.html[TestKit]. [link:https://github.com/bmuschko/gradle-site-plugin/blob/master/build.gradle#L6[Code] | link:https://docs.gradle.org/current/userguide/test_kit.html[More Details]]