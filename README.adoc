= Building Java Web Applications image:https://travis-ci.org/gradle-guides/building-java-web-applications.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/building-java-web-applications?branch=master"]
