= Testing Gradle Plugins image:https://travis-ci.org/gradle-guides/testing-gradle-plugins.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/testing-gradle-plugins?branch=master"]
