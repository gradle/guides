= Writing Gradle Tasks image:https://travis-ci.org/gradle-guides/writing-gradle-tasks.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/writing-gradle-tasks?branch=master"]
