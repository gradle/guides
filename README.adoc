= Build Cache Practices image:https://travis-ci.org/gradle-guides/build-cache-practices.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/build-cache-practices?branch=master"]
