= Creating Java Applications image:https://travis-ci.org/gradle-guides/creating-java-applications.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/creating-java-applications?branch=master"]
