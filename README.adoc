= Creating Build Scans image:https://travis-ci.org/gradle-guides/creating-build-scans.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/creating-build-scans?branch=master"]
