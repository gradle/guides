= executing-gradle-builds-on-teamcity image:https://travis-ci.org/gradle-guides/executing-gradle-builds-on-teamcity.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/executing-gradle-builds-on-teamcity?branch=master"]
