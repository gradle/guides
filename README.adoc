= Using Node.js Libraries image:https://travis-ci.org/gradle-guides/using-node-js-libraries.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/using-node-js-libraries?branch=master"]
