= Writing Gradle Tasks image:https://travis-ci.org/gradle-guides/creating-new-gradle-builds.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/creating-new-gradle-builds?branch=master"]
