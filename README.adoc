= Building C++ Executables image:https://travis-ci.org/gradle-guides/building-cpp-executables.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/building-cpp-executables?branch=master"]
