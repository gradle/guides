= Performance Guide image:https://travis-ci.org/gradle-guides/performance.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/performance?branch=master"]
