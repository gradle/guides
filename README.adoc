= Building Kotlin JVM Libraries image:https://travis-ci.org/gradle-guides/building-kotlin-jvm-libraries.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/building-kotlin-jvm-libraries?branch=master"]
