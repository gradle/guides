= Using the Build Cache image:https://travis-ci.org/gradle-guides/using-build-cache.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/using-build-cache?branch=master"]
