= Building Scala Libraries image:https://travis-ci.org/gradle-guides/building-scala-libraries.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/building-scala-libraries?branch=master"]
