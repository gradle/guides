= Writing Gradle Plugins image:https://travis-ci.org/gradle-guides/writing-gradle-plugins.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/writing-gradle-plugins?branch=master"]
