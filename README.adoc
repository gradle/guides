= Building C++ Libraries image:https://travis-ci.org/gradle-guides/building-cpp-libraries.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/building-cpp-libraries?branch=master"]
