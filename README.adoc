= Implementing Gradle Plugins image:https://travis-ci.org/gradle-guides/implementing-gradle-plugins.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/implementing-gradle-plugins?branch=master"]
