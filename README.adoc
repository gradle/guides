= Designing Gradle Plugins image:https://travis-ci.org/gradle-guides/designing-gradle-plugins.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/designing-gradle-plugins?branch=master"]
