...
----
<1> Use latest version of plugin
====
...
NOTE: The latest version of the plugin can be found from the https://plugins.gradle.org/plugin/com.gradle.build-scan[Gradle Plugin Portal].
